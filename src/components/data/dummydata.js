...
export const home = [
  {
    text: "HELLO I'M Soliman Front end Dev",
    name: "Soliman Said",
    post: "WEB DESIGNER",
...
export const contact = [
  {
    ...
    text1: "Cairo-Nasr city-Mustafa El-Nahhas",
    text2: "Alexandrai , Roshdy ",
  },
  {
    icon: <PhoneIphone />,
    text1: "01114491730",
  ...
  {
    icon: <EmailOutlined />,
    text1: "soliman.farag86@gmail.com",
  },
];
export const social = [
  {
